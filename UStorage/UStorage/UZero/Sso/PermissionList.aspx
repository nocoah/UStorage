<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="PermissionList.aspx.cs" Inherits="UZeroConsole.Web.UZero.Sso.PermissionList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="content bg-gray-lighter">
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading">控制台Sso权限管理<small> 当前权限共分为 3 级嵌套，权限对应左则菜单。</small>
                </h1>
            </div>
            ...
            <div class="block-content">
                <div>
                    <% if (Model.Apps != null && Model.Apps.Count() > 0)
                        { %>
                    <select class="form-control" id="ddlApps">
