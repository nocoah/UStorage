<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="AdminCreate.aspx.cs" Inherits="UZeroConsole.Web.UZero.Sso.AdminCreate" %>
            ...
            <div class="row items-push">
                ...
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li><a class="link-effect" href="AdminList.aspx">Sso管理员列表</a></li>
                        <li>添加管理员</li>
                    </ol>
                </div>
            </div>
