<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="UZeroConsole.Web.UZeroLogging.ExceptionLogs.List" %>
    ...
    <form runat="server">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading"><%= Model.App.Name %><small> <%= Model.App.Description %> - 所有的异常及错误信息</small>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="form-inline">
                        <div class="form-group ">
                            ...
                            <label>
                                <input type="text" id="tbKeywords" class="form-control" placeholder="关键字.." value="<%= Model.GetKeywords %>" /></label>
                ...
                <div class="block-content table-responsive">
                    ...
                    <table class="table table-hover js-dataTable-full">
                        <thead>
                            <tr>
                                <th  style="width: 5%"></th>
                                <th class="text-center" style="width: 13%">主机名</th>
                                ...
                                <th class="text-center" style="width: 10%">状态码</th>
                            ...
                            <ItemTemplate>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><%# Eval("MachineName")%></td>
                                        ...
                                        <td class="text-center"><%# Eval("StatusCode")%></td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnClearAll').click(function () {
                if (confirm('你确定清除【<%= Model.App.Name%>】的所有异常日志吗？')) {
                    var appId = parseInt("<%= Model.GetAppId %>");
                    ExceptionLogService.ClearAll(appId, function (res) {
